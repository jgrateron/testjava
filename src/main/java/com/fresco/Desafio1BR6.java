...
public class Desafio1BR6 {
	public static String FILE = "./measurements300.txt";
	public static Map<Index, Medicion> mapMedicionesTotales = new TreeMap<Index, Medicion>();
	...
	public static class Worker extends Thread {
		...
		public Worker(ByteBuffer byteBuffer, int remaining) throws IOException {
			...
			this.mapMediciones = new TreeMap<>();
