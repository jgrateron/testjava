...
public class Collisions {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("count stations= " +stations.size());
        System.out.println();
    }

    private static int calcHashCode(int result, byte[] a, int fromIndex, int length) {
    ...
    public static List<WeatherStation> stations = List.of(
