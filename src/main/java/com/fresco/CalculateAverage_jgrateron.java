...
public class CalculateAverage_jgrateron {
    ...
    public static void main(String[] args) throws InterruptedException, IOException {
        ...
        var totalMediciones = new HashMap<ByteBuffer, Medicion>();
        ...
        Comparator<Map.Entry<ByteBuffer, Medicion>> comparar = (a, b) -> {
    ...
    static class MiTarea implements AutoCloseable {
         ...
         */
        public Map<ByteBuffer, Medicion> calcularMediciones() throws IOException {
        ...
        public int buscarSemicolon(byte data[], int len) {
            int pos = len - 4;
            pos = data[pos] == ';' ? pos
                    : data[pos - 1] == ';' ? pos - 1 : data[pos - 2] == ';' ? pos - 2 : data[pos - 3] == ';' ? pos - 3 : data[pos - 4] == ';' ? pos - 4 : 0;
            return pos;
        }
